...
var changingFontStyle = function (fontstyle) {
  ...
  document.getElementById("i14").style.fontFamily = fontstyle.value;
  document.getElementById("i15").style.fontFamily = fontstyle.value;
  document.getElementById("i16").style.fontFamily = fontstyle.value;
  document.getElementById("i17").style.fontFamily = fontstyle.value;
  document.getElementById("i18").style.fontFamily = fontstyle.value;
  document.getElementById("i19").style.fontFamily = fontstyle.value;
}
...
function selectColor() {
  ...
  document.getElementById("i14").style.color = color.value;
  document.getElementById("i15").style.color = color.value;
  document.getElementById("i16").style.color = color.value;
  document.getElementById("i17").style.color = color.value;
  document.getElementById("i18").style.color = color.value;
  document.getElementById("i19").style.color = color.value;
}
